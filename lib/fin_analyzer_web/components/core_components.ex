defmodule FinAnalyzerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FinAnalyzerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FinAnalyzerWeb.Gettext, "errors", msg, opts)
    end
  end
